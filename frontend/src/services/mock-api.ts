...
const SEED_NOTIFICATIONS: Notification[] = [
  { id: 'notif-1', userId: 'user-1', type: 'REMINDER', category: 'MILESTONE', title: 'Trip coming up!', body: 'Hawaii Beach Vacation starts in 2 weeks', referenceId: 'trip-1', referenceType: 'TRIP', link: '/trip/trip-1', isRead: false, createdAt: '2026-02-15T10:00:00Z' },
  ...
  { id: 'notif-3', userId: 'user-1', type: 'PAYMENT_DUE', category: 'SETTLEMENT', title: 'Payment needed', body: 'You owe $120 for Luau Dinner - please pay Sarah', referenceId: 'trip-1', referenceType: 'BILL_SPLIT', link: '/trip/trip-1/payments', isRead: false, createdAt: '2026-02-13T09:00:00Z' },
  { id: 'notif-4', userId: 'user-1', type: 'ACTIVITY', category: 'MEMBER', title: 'Activity confirmed!', body: 'Hotel: Grand Wailea has been confirmed!', referenceId: 'trip-1', referenceType: 'TRIP', link: '/trip/trip-1', isRead: true, createdAt: '2026-02-01T15:00:00Z' },
  { id: 'notif-5', userId: 'user-1', type: 'REMINDER', category: 'MILESTONE', title: 'Trip this weekend!', body: 'NYC Birthday Weekend is this weekend - have fun!', referenceId: 'trip-2', referenceType: 'TRIP', link: '/trip/trip-2', isRead: true, createdAt: '2026-04-15T10:00:00Z' },
  { id: 'notif-6', userId: 'user-1', type: 'MESSAGE', category: 'CHAT', title: 'Tagged in chat', body: 'Sarah mentioned you in the Nashville trip chat', referenceId: 'trip-5', referenceType: 'MESSAGE', link: '/trip/trip-5/chat', isRead: false, createdAt: '2026-02-18T20:00:00Z' },

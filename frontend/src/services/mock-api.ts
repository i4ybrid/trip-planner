...
const SEED_NOTIFICATIONS: Notification[] = [
  { id: 'notif-1', userId: 'user-1', type: 'MILESTONE', category: 'MILESTONE', title: 'Trip coming up!', body: 'Hawaii Beach Vacation starts in 2 weeks', referenceId: 'trip-1', referenceType: 'TRIP', link: '/trip/trip-1', isRead: false, createdAt: '2026-02-15T10:00:00Z' },
  { id: 'notif-2', userId: 'user-1', type: 'VOTE', category: 'MEMBER', title: 'Vote needed', body: 'Vote on Surfing Lessons activity for Hawaii trip', referenceId: 'trip-1', referenceType: 'TRIP', link: '/trip/trip-1', isRead: false, createdAt: '2026-02-14T15:00:00Z' },
  { id: 'notif-3', userId: 'user-1', type: 'PAYMENT_REQUEST', category: 'SETTLEMENT', title: 'Payment needed', body: 'You owe $120 for Luau Dinner - please pay Sarah', referenceId: 'trip-1', referenceType: 'BILL_SPLIT', link: '/trip/trip-1/payments', isRead: false, createdAt: '2026-02-13T09:00:00Z' },
  { id: 'notif-4', userId: 'user-1', type: 'MILESTONE', category: 'MEMBER', title: 'Activity confirmed!', body: 'Hotel: Grand Wailea has been confirmed!', referenceId: 'trip-1', referenceType: 'TRIP', link: '/trip/trip-1', isRead: true, createdAt: '2026-02-01T15:00:00Z' },
  { id: 'notif-5', userId: 'user-1', type: 'TRIP_STARTING', category: 'MILESTONE', title: 'Trip this weekend!', body: 'NYC Birthday Weekend is this weekend - have fun!', referenceId: 'trip-2', referenceType: 'TRIP', link: '/trip/trip-2', isRead: true, createdAt: '2026-04-15T10:00:00Z' },
  { id: 'notif-6', userId: 'user-1', type: 'DM_MESSAGE', category: 'CHAT', title: 'Tagged in chat', body: 'Sarah mentioned you in the Nashville trip chat', referenceId: 'trip-5', referenceType: 'MESSAGE', link: '/trip/trip-5/chat', isRead: false, createdAt: '2026-02-18T20:00:00Z' },
  { id: 'notif-7', userId: 'user-1', type: 'INVITE', category: 'INVITE', title: 'New member joined', body: 'Emma Wilson joined Hawaii Beach Vacation', referenceId: 'trip-1', referenceType: 'TRIP', link: '/trip/trip-1', isRead: true, createdAt: '2026-01-18T09:00:00Z' },
  { id: 'notif-8', userId: 'user-1', type: 'TRIP_STARTING', category: 'MILESTONE', title: 'Trip happening now!', body: 'Your Nashville trip is happening right now!', referenceId: 'trip-5', referenceType: 'TRIP', link: '/trip/trip-5', isRead: false, createdAt: '2026-02-18T08:00:00Z' },
  { id: 'notif-9', userId: 'user-1', type: 'FRIEND_REQUEST', category: 'FRIEND', title: 'Friend request', body: 'Emma Wilson sent you a friend request', referenceId: 'fr-1', referenceType: 'FRIEND_REQUEST', link: '/friends', isRead: false, createdAt: '2026-02-15T00:00:00Z' },
];

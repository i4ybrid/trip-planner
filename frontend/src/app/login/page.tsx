...
// Apple logo SVG — follows Apple brand guidelines
const AppleIcon = () => (
  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="space-y-3">
            ...
            {/* Apple Sign In — black button per Apple branding guidelines */}
            <button
              type="button"
              onClick={() => signIn('apple', { callbackUrl: '/dashboard' })}
              className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-black rounded-lg hover:bg-gray-800 transition-colors bg-black text-white"
            >
              <AppleIcon />

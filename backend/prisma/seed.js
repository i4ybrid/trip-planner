...
const SEED_MEMBERS = [
    ...
    { tripId: 'trip-1', userId: 'user-2', role: 'MEMBER', status: 'CONFIRMED' },
    { tripId: 'trip-1', userId: 'user-3', role: 'MEMBER', status: 'CONFIRMED' },
    { tripId: 'trip-1', userId: 'user-4', role: 'MEMBER', status: 'MAYBE' },
    { tripId: 'trip-2', userId: 'user-2', role: 'MASTER', status: 'CONFIRMED' },
    { tripId: 'trip-2', userId: 'user-1', role: 'MEMBER', status: 'CONFIRMED' },
    { tripId: 'trip-3', userId: 'user-1', role: 'MASTER', status: 'CONFIRMED' },
    { tripId: 'trip-4', userId: 'user-3', role: 'MASTER', status: 'CONFIRMED' },
    { tripId: 'trip-4', userId: 'user-1', role: 'MEMBER', status: 'CONFIRMED' },
    { tripId: 'trip-4', userId: 'user-2', role: 'MEMBER', status: 'CONFIRMED' },
    { tripId: 'trip-5', userId: 'user-2', role: 'MASTER', status: 'CONFIRMED' },
    { tripId: 'trip-5', userId: 'user-1', role: 'MEMBER', status: 'CONFIRMED' },
    { tripId: 'trip-5', userId: 'user-4', role: 'MEMBER', status: 'CONFIRMED' },
];

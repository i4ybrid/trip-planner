...
const SEED_MEMBERS = [
    { tripId: 'trip-1', userId: 'user-1', role: 'OWNER', status: 'CONFIRMED' },
    { tripId: 'trip-1', userId: 'user-2', role: 'VIEWER', status: 'CONFIRMED' },
    { tripId: 'trip-1', userId: 'user-3', role: 'VIEWER', status: 'CONFIRMED' },
    { tripId: 'trip-1', userId: 'user-4', role: 'VIEWER', status: 'MAYBE' },
    { tripId: 'trip-2', userId: 'user-2', role: 'OWNER', status: 'CONFIRMED' },
    { tripId: 'trip-2', userId: 'user-1', role: 'VIEWER', status: 'CONFIRMED' },
    { tripId: 'trip-3', userId: 'user-1', role: 'OWNER', status: 'CONFIRMED' },
    { tripId: 'trip-4', userId: 'user-3', role: 'OWNER', status: 'CONFIRMED' },
    { tripId: 'trip-4', userId: 'user-1', role: 'VIEWER', status: 'CONFIRMED' },
    { tripId: 'trip-4', userId: 'user-2', role: 'VIEWER', status: 'CONFIRMED' },
    { tripId: 'trip-5', userId: 'user-2', role: 'OWNER', status: 'CONFIRMED' },
    { tripId: 'trip-5', userId: 'user-1', role: 'VIEWER', status: 'CONFIRMED' },
    { tripId: 'trip-5', userId: 'user-4', role: 'VIEWER', status: 'CONFIRMED' },
];

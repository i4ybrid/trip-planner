...
exports.debtSimplifierService = exports.DebtSimplifierService = void 0;
...
class DebtSimplifierService {
    ...
    async calculateBalances(tripId) {
        ...
        const tripMembers = await prisma_1.default.tripMember.findMany({
     ...
     */
    async getSimplifiedDebts(tripId) {
...
exports.DebtSimplifierService = DebtSimplifierService;
exports.debtSimplifierService = new DebtSimplifierService();
//# sourceMappingURL=debtSimplifier.service.js.map
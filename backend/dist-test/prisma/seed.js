...
const SEED_MEMBERS = [
    { tripId: 'trip-1', userId: 'user-1', role: 'MASTER', status: 'CONFIRMED' },
    { tripId: 'trip-1', userId: 'user-2', role: 'ORGANIZER', status: 'CONFIRMED' },
    { tripId: 'trip-1', userId: 'user-3', role: 'ORGANIZER', status: 'CONFIRMED' },
    { tripId: 'trip-1', userId: 'user-4', role: 'ORGANIZER', status: 'MAYBE' },
    { tripId: 'trip-2', userId: 'user-2', role: 'MASTER', status: 'CONFIRMED' },
    { tripId: 'trip-2', userId: 'user-1', role: 'ORGANIZER', status: 'CONFIRMED' },
    { tripId: 'trip-3', userId: 'user-1', role: 'MASTER', status: 'CONFIRMED' },
    { tripId: 'trip-4', userId: 'user-3', role: 'MASTER', status: 'CONFIRMED' },
    { tripId: 'trip-4', userId: 'user-1', role: 'ORGANIZER', status: 'CONFIRMED' },
    { tripId: 'trip-4', userId: 'user-2', role: 'ORGANIZER', status: 'CONFIRMED' },
    { tripId: 'trip-5', userId: 'user-2', role: 'MASTER', status: 'CONFIRMED' },
    { tripId: 'trip-5', userId: 'user-1', role: 'ORGANIZER', status: 'CONFIRMED' },
    { tripId: 'trip-5', userId: 'user-4', role: 'ORGANIZER', status: 'CONFIRMED' },
];
...
const SEED_VOTES = [
    { activityId: 'act-1', userId: 'user-1', option: 'YES' },
    { activityId: 'act-1', userId: 'user-2', option: 'YES' },
    { activityId: 'act-1', userId: 'user-3', option: 'MAYBE' },
    { activityId: 'act-2', userId: 'user-1', option: 'YES' },
    { activityId: 'act-2', userId: 'user-2', option: 'YES' },
    { activityId: 'act-3', userId: 'user-1', option: 'YES' },
    { activityId: 'act-3', userId: 'user-2', option: 'NO' },
    { activityId: 'act-4', userId: 'user-1', option: 'YES' },
    { activityId: 'act-4', userId: 'user-2', option: 'YES' },
    { activityId: 'act-4', userId: 'user-3', option: 'YES' },
...
const SEED_BILL_SPLIT_MEMBERS = [
    { billSplitId: 'bill-1', userId: 'user-1', dollarAmount: 450, type: 'EQUAL', status: 'PAID', paymentMethod: 'VENMO' },
    { billSplitId: 'bill-1', userId: 'user-2', dollarAmount: 450, type: 'EQUAL', status: 'PENDING' },
    { billSplitId: 'bill-1', userId: 'user-3', dollarAmount: 450, type: 'EQUAL', status: 'PAID', paymentMethod: 'VENMO' },
    { billSplitId: 'bill-1', userId: 'user-4', dollarAmount: 450, type: 'EQUAL', status: 'PENDING' },
    { billSplitId: 'bill-2', userId: 'user-1', dollarAmount: 90, type: 'EQUAL', status: 'PAID', paymentMethod: 'CASH' },
    { billSplitId: 'bill-2', userId: 'user-2', dollarAmount: 90, type: 'EQUAL', status: 'PAID', paymentMethod: 'CASH' },
    { billSplitId: 'bill-2', userId: 'user-3', dollarAmount: 90, type: 'EQUAL', status: 'PAID', paymentMethod: 'CASH' },
    { billSplitId: 'bill-2', userId: 'user-4', dollarAmount: 90, type: 'EQUAL', status: 'PENDING' },
];
const SEED_EXPENSES = [
    {
        tripId: 'trip-1',
...
const SEED_MEDIA = [
    ...
    { tripId: 'trip-5', uploaderId: 'user-2', type: 'image', url: 'https://images.unsplash.com/photo-1514933651103-005eec06c04b?w=800', caption: 'Broadway neon lights' },
    { tripId: 'trip-5', uploaderId: 'user-1', type: 'image', url: 'https://images.unsplash.com/photo-1544542900-1af4c07e98d8?w=800', caption: 'Guitar shop on Broadway' },
];
...
const SEED_DM_MESSAGES = [
    { conversationId: 'dm-1', senderId: 'user-1', content: 'Hey! Can\'t wait for the trip!', messageType: 'TEXT' },
    { conversationId: 'dm-1', senderId: 'user-2', content: 'Me neither! Already packed my bags!', messageType: 'TEXT' },
];
async function main() {
    ...
    const billSplitResults = await Promise.all(SEED_BILL_SPLITS.map((billData, i) => {
    ...
    await Promise.all(billSplitMemberData.map((memberData) => prisma.billSplitMember.upsert({
    ...
    const dmConversationIdMap = new Map();
